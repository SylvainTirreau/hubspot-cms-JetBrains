...
public class HublParser implements PsiParser, LightPsiParser {
  ...
  static boolean parse_root_(IElementType t, PsiBuilder b, int l) {
    return HublFile(b, l + 1);
  }

  /* ********************************************************** */
  // item_*
  static boolean HublFile(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "HublFile")) return false;
    while (true) {
      int c = current_position_(b);
      if (!item_(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "HublFile", c)) break;
    }
    return true;
  }
  ...
  public static boolean property(PsiBuilder b, int l) {
    ...
    exit_section_(b, l, m, r, false, HublParser::recover_property);
    return r;
  }
