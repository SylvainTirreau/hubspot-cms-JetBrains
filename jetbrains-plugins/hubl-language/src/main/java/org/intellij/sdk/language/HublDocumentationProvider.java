 ...
 */
final class HublDocumentationProvider extends AbstractDocumentationProvider {

  /**
   * For the Hubl Language, we don't have online documentation. However, if your language provides
  ...
  /**
   * Extracts the key, value, file and documentation comment of a Hubl key/value entry and returns
   * a formatted representation of the information.
   */
  @Override
  public @Nullable String generateDoc(PsiElement element, @Nullable PsiElement originalElement) {
    if (element instanceof HublProperty) {
      final String key = ((HublProperty) element).getKey();
      final String value = ((HublProperty) element).getValue();
      final String file = SymbolPresentationUtil.getFilePathPresentation(element.getContainingFile());
      final String docComment = HublUtil.findDocumentationComment((HublProperty) element);
  ...
  /**
   * Provides the information in which file the Hubl language key/value is defined.
   */
  @Override
  ...
  /**
   * Provides documentation when a Hubl Language element is hovered with the mouse.
   */
  @Override
