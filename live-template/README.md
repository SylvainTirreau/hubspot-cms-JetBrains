# hubspot-cms-JetBrains Live Templating

For fast HubSpot CMS Hub development with JetBrains IDEs (Webstorm, PHPStorm, Pycharm, etc.).

Those files adapt the [HubSpot Visual Studio Code Extension](https://github.com/HubSpot/hubspot-cms-vscode) for JetBrains IDEs (Webstorm, PHPStorm, Pycharm, etc.) and it currently supports:
- ~~Syntax highlighting for the HubL templating language~~ ¹
- Autocomplete for common HubL tags, filters, module fields, and functions
